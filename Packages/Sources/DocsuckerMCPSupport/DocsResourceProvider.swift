...
public actor DocsResourceProvider: ResourceProvider {
    private let configuration: DocsuckerConfiguration
    private var metadata: CrawlMetadata?
    private let evolutionDirectory: URL

    public init(configuration: DocsuckerConfiguration, evolutionDirectory: URL? = nil) {
        self.configuration = configuration
        self.evolutionDirectory = evolutionDirectory ?? FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".docsucker/swift-evolution")
...
enum ResourceError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .noDocumentation:
            return "No documentation has been crawled yet. Run 'docsucker crawl' first."
        }
    }
}
